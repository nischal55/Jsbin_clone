    ...
    <>
      <div className="w-full h-10 bg-zinc-200 border border-gray-500 flex justify-between text-xs text-gray-600">
        <div
          ...
          } absolute text-blue-400 font-bold h-screen bg-blue-100 fixed top-0 buttom-0 right-0 w-[50%] md:hidden z-20 `}
        >
        ...
        <div
          className={`hidden ${
            mdMenuOpen ? "md:block transition-all" : "md:hidden transition-all"
        ...
        <div className="hidden md:text-sm  md:flex md:h-6 md:mt-2 ">
          {loginStatus ? (
            ...
            <Link className="px-2" onClick={logout}>Logout</Link>
            </>
          ) : (
            <>
